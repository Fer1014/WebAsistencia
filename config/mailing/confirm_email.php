<?php
	...
	function send_confirm_email($email,$token){
		...
		try {
		    ...
		    $mail->isHTML(true);
		    $mail->Subject = utf8_decode('Confirmación de correo | Arkxpres');
		    $mail->Body='<h3>Bienvenido</h3>
		    <label>Click al siguiente enlace para continuar: <a href="https://arkxpres.com/_confirm-email.php?t='.$token.'">Confirmar mi correo</a></label>';
		    if($mail->send()){
			    return "1";
			}else{
				return "2";
