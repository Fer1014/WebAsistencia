<div class="contenedor-carrito">
	<h2 class="mt10">Historial de pedidos</h2>
	...
	where codusu=$codusu and ped.estado!=3 and ped.estado!=2
	...
	?>
		<div class="item-pedido">
			...
			<h4>Monto total:&nbsp;$&nbsp;<?php echo $row['cantidad']; ?></h4>
